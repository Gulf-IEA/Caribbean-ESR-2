...
-   [ ] Coral cover and species diversity
-   [ ] Earthquake activity
-   [ ] Economic activity
...
-   [ ] Turbidity
-   [ ] Water quality
-   [x] Not yet linked to an indicator

## Category (Which group is this indicator associated with?)

-   [ ] Tracking performance toward fishery management objectives
...
-   [ ] Automated download
-   [ ] Fishery-dependent (confidential data)
-   [x] Non-automated data access
...
Name: column1, Definition: a measure of something, Units: meters Name: column 2, Definition: a measure of something else, Units: numbers (thousands)
