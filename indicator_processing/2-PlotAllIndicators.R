...
plotIndicatorTimeSeries(ind, coltoplot = 1:3, plotrownum = 3, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%m-%Y", 
                        sublabel = TRUE, widadj = 1, hgtadj = 0.5, anom = "stmon", yposadj = 1, cex.axis = 1, cex.lab = 1, cex.main = 1,
...
plotIndicatorTimeSeries(ind, coltoplot = 1:3, plotrownum = 3, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%m-%Y", 
                        sublabel = TRUE, widadj = 1.5, hgtadj = 0.5, anom = "none", yposadj = 1, cex.axis = 1, cex.lab = 1, cex.main = 1, 
...
plotIndicatorTimeSeries(ind, coltoplot = 1, plotrownum = 1, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%b%Y", 
                        sublabel = F, widadj = 2, hgtadj = 1, anom = "none", yposadj = 1, cex.axis = 1, cex.lab = 1, cex.main = 1, 
...
plotIndicatorTimeSeries(ind, coltoplot = 1:3, plotrownum = 3, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%b%Y", 
                        sublabel = TRUE, widadj = 1, hgtadj = 0.8, anom = "none", yposadj = 1.2, cex.axis = 1, cex.lab = 1, cex.main = 1, 
...
plotIndicatorTimeSeries(ind, coltoplot = 1:4, plotrownum = 2, plotcolnum = 2, trendAnalysis = TRUE, dateformat = "%b%Y", 
                        sublabel = TRUE, widadj = 1.8, hgtadj = 1.2, anom = "none", yposadj = 1.2, sameYscale = FALSE, cex.axis = 1, cex.lab = 1, cex.main = 1, 
...
plotIndicatorTimeSeries(ind, coltoplot = 1:6, plotrownum = 3, plotcolnum = 2, trendAnalysis = TRUE, dateformat = "%b%Y", 
                        sublabel = TRUE, widadj = 1.8, hgtadj = 1, anom = "none", yposadj = 1, cex.axis = 1, cex.lab = 1, cex.main = 1, 
...
plotIndicatorTimeSeries(ind, coltoplot = 1:3, plotrownum = 3, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%b%Y",
                        sublabel = TRUE, widadj = 1, hgtadj = 0.5, anom = "none", yposadj = 1, cex.axis = 1, cex.lab = 1, cex.main = 1, 
...
plotIndicatorTimeSeries(ind, coltoplot = 1:3, plotrownum = 3, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%b%Y", 
                        sublabel = TRUE, widadj = 1, hgtadj = 0.5, anom = "none", yposadj = 1.2, sameYscale = FALSE, cex.axis = 1, cex.lab = 1, cex.main = 1, 
...
plotIndicatorTimeSeries(ind, coltoplot = 1:5, plotrownum = 5, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%b%Y", 
                        sublabel = TRUE, widadj = 1.8, hgtadj = 0.7, anom = "none", yposadj = 1.2, cex.axis = 1, cex.lab = 1, cex.main = 1, 
...
plotIndicatorTimeSeries(ind, coltoplot = 1:8, plotrownum = 4, plotcolnum = 2, trendAnalysis = TRUE, dateformat = "%b%Y", 
                        sublabel = TRUE, widadj = 5, hgtadj = 1, anom = "none", yposadj = 1.2, cex.axis = 1, cex.lab = 1, cex.main = 1, 
...
plotIndicatorTimeSeries(ind, coltoplot = 1:3, plotrownum = 3, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%b%Y", 
                        sublabel = TRUE, widadj = 1, hgtadj = 0.5, anom = "none", yposadj = 1.2, cex.axis = 1.2, cex.lab = 1.5, cex.main = 1.6, sameYscale = TRUE, 
...
plotIndicatorTimeSeries(ind, coltoplot = 1:3, plotrownum = 3, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%b%Y", 
                        sublabel = TRUE, widadj = 1, hgtadj = 0.5, anom = "none", yposadj = 1.2, cex.axis = 1, cex.lab = 1, cex.main = 1, sameYscale = FALSE, 
...
plotIndicatorTimeSeries(ind, coltoplot = 1:2, plotrownum = 2, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%b%Y", 
                        sublabel = TRUE, widadj = 1, hgtadj = 0.5, anom = "none", yposadj = 1, sameYscale = F, cex.axis = 1, cex.lab = 1, cex.main = 1, 
...
plotIndicatorTimeSeries(ind, coltoplot = 1:2, plotrownum = 2, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%b%Y", 
                        sublabel = TRUE, widadj = 1.5, hgtadj = 0.8, anom = "none", yposadj = 1, sameYscale = F, cex.axis = 1, cex.lab = 1, cex.main = 1, 
...
plotIndicatorTimeSeries(ind, coltoplot = 1, plotrownum = 1, plotcolnum = 1, trendAnalysis = TRUE, dateformat = "%b-%y", 
                        sublabel = F, widadj = 7, hgtadj = 1, anom = "none", yposadj = 1, cex.lab = 1, type = "allLines", 
...
plotIndicatorTimeSeries(ind, coltoplot = 1:4, plotrownum = 2, plotcolnum = 2, trendAnalysis = TRUE, dateformat = "%b%Y", 
                        sublabel = TRUE, widadj = 1.8, hgtadj = 1.2, anom = "none", yposadj = 1, cex.axis = 1, cex.lab = 1, cex.main = 1, 
