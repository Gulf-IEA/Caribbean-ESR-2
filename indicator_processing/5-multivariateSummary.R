...
png(filename = "indicator_plots/traffic.png", units="in", width=16, height=14, pointsize=24, res=72*12)
...
mtext(side = 2, "Risks to meeting objectives", line = 9, cex = 0.9)
...
mtext(side = 2, "Other management indicators", line = 9, cex = 0.9)
