...
![CSVI plots PR](/indicator_plots/CSVI_plots/PR_vulnerability.png){#fig-CSVIPR fig-alt="Plot showing a time series of an indicator"}

![CSVI plots St. Thomas and St. John](/indicator_plots/CSVI_plots/STSJ_vulnerability.png){#fig-CSVISTT fig-alt="Plot showing a time series of an indicator"}
