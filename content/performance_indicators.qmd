...
![Total landings of lobsters (top row), conch (middle row), and all other commercial species (bottom row) from commercial landings data in Puerto Rico (left column), St. Thomas and St. John (middle column) and St. Croix (right column).](/indicator_plots/total_landings_plot_final.png){#fig-totalland fig-alt="a plot" fig-align="center"}
