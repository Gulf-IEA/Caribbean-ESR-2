...
% Title and subtitle
{{\Large{\nohyphens{Caribbean Ecosystem Status Report}}}\par
}%
}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{indicator_plots/RVC_PR_plot_final.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{indicator_plots/RVC_STSJ_plot_final.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{indicator_plots/RVC_STX_plot_final.png}
...
in landings of demersal fish species
(Figure~\ref{fig-PD}).\end{minipage}%
%
...
behavior tied to impacts from the 2017 hurricanes.\end{minipage}%
%
\begin{minipage}{0.05\linewidth}
...
\includegraphics[width=1\textwidth,height=\textheight]{indicator_plots/avgLmax_plot_final.png}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{indicator_plots/PR_Lmax_classes_plot_final.png}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{indicator_plots/STT_Lmax_classes_plot_final.png}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{indicator_plots/STX_Lmax_classes_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/prop_diving_trips_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/GDP_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/oceanNAICS_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/gini_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/total_rec_catch_plot_final.png}
...
\includegraphics{indicator_plots/CSVI_plots/PR_engrel_maps.png}
...
\includegraphics{indicator_plots/CSVI_plots/STSJ_engrel_maps.png}
...
\includegraphics{indicator_plots/CSVI_plots/STX_engrel_maps.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/prop_trips_bycatch_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/FRsection_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/tier3_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/outreach_plot_final.png}
...
\includegraphics{indicator_plots/enforcement_barplot.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/ACEindex_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/earthquakes_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/pollution_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/turbidity_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/enterococcus_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/Sargassum_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/disturbance_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/population_plot_final.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{indicator_plots/hotel_plot_final.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{indicator_plots/traffic.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{indicator_plots/pcas.png}
